...
const project = {
  ...
  devices: [{ id: "light-1", roomId: "living", x: 250, y: 125, type: "light", ha: { entityId: "light.alarm_light", title: "Alarm light", mode: "icon-and-label", icon: "", iconSizePx: 24, label: { enabled: true, offsetY: 20, fontSizePx: 12, color: "#fff" }, tapAction: { action: "toggle" }, holdAction: { action: "more-info" }, doubleTapAction: { action: "none" } } }],
